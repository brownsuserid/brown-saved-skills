---
name: afternoon-email-triage
description: Afternoon email triage: identical full triage session at noon. Same format, same enrichment, same commands as morning.
---

Run the email-morning-triage skill. This is the 12 PM afternoon triage session. It is identical to the morning session.
...
Use the email-morning-triage skill for the complete workflow instructions. Run the full format, not a lighter sweep. This is identical to morning triage.